...
public class CourseController {
    ...
    @GetMapping("/list")
    public String index(Model model, @ModelAttribute CourseForm courseForm, @RequestParam(value="courseId", required=false) Integer courseId, @RequestParam(value="courseName", required=false) String courseName) {
    ...
    public String delete(@PathVariable Integer id) {
    	this.courseService.deletedById(id);
    	return "redirect:/course/list";
    }
}